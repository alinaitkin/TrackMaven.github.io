Title: Comparing ES6 to Coffeescript - An Experiment
Date: 2015-09-15
Category: Javascript
...
With the introduction of ES6 (or ES2015), we have seen a lot of the good parts of Coffeescript get absorbed into Javascript, and it begs the question: Should we stay with Coffeescript or go to writing native Javascript once ES6 is released. To answer that question, I did a little experiment with a portion of our code that's written in Coffeescript. Below you will see examples of code written in a) Coffeescript b) Javascript that was autogenerated through [js2.coffee](http://js2.coffee) c) ES6 Javascript (using the latest released version: X.X) and d) Javascript that was autogenerated through the [Babel.js Repl](https://babeljs.io/repl/).
...
I feel that ever though ES6 is going in the right direction, it is a huge leap down from where we currently are with Coffeescript. Of course there are tons of benefits from getting away from Coffeescript and start writing ES6, but right now I think we will be sticking with Coffeescript.

What's your thoughts? Any users of Coffeescript make the jump successfully? Anyone think we're crazy with sticking with Coffeescript? Let us know below in the comments. Thanks!
